// Preguntas para cada tipo de assessment
export const questionsData = {
  ...
  optimization: [
    { id: 1, category: 'Compute', question: '¿Cuántas instancias EC2/VMs tiene en ejecución actualmente?', type: 'number', phase: 'Assess' },
    { id: 2, category: 'Compute', question: '¿Utiliza instancias Spot o preemptibles?', phase: 'Assess' },
    { id: 3, category: 'Storage', question: '¿Tiene políticas de lifecycle para datos antiguos?', phase: 'Assess' },
    { id: 4, category: 'Storage', question: '¿Monitorea snapshots y backups no utilizados?', phase: 'Assess' },
    { id: 5, category: 'Network', question: '¿Optimiza la transferencia de datos entre regiones?', phase: 'Assess' },
    { id: 6, category: 'Database', question: '¿Utiliza instancias de base de datos reservadas?', phase: 'Assess' },
    ...
    { id: 10, category: 'Commitment', question: '¿Revisa y ajusta sus compromisos (RI/SP) trimestralmente?', phase: 'Assess' },
  ],
  ...
  service: [
    ...
    { id: 8, category: 'Goals', question: '¿Cuál es su objetivo principal? (Reducir costos, Visibilidad, Gobernanza)', type: 'select', options: ['Reducir costos', 'Visibilidad', 'Gobernanza', 'Todo lo anterior'], phase: 'Evaluate' },
...
// Opciones de respuesta por defecto
